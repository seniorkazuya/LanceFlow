...
function buildStartUrl(accountType?: PortalAccountType): string {
...
export function GoogleSignInButton({
  ...
  return (
    <a href={buildStartUrl(accountType)} className="btn btn-google">
      <GoogleMark />
      {label}
    </a>
  );
...
function GoogleMark() {
  return (
    <svg aria-hidden viewBox="0 0 24 24" className="btn-google-icon">
      <path
        fill="#4285F4"
