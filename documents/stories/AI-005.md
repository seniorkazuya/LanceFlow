# AI-005: Role-specific hiring weight profiles
...
| **Depends on** | HIRE-004 |
| **Branch** | `feature/AI-005-role-weights` |
| **Status** | Backlog |
...
```
You are implementing LanceFlow story AI-005: Role-specific hiring weight profiles.
