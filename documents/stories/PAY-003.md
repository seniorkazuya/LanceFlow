# PAY-003: Milestone-linked payment reminders
...
| **Depends on** | PAY-001,AUTO-005 |
| **Branch** | `feature/PAY-003-milestone-remind` |
| **Status** | Backlog |
...
```
You are implementing LanceFlow story PAY-003: Milestone-linked payment reminders.
