...
- [x] PR template reminds to update PROJECT_STATUS.md
- [x] GitHub Project board template documented
- [x] Repo About links to PROJECT_STATUS.md
- [x] Workflow syncs [project #4](https://github.com/users/seniorkazuya/projects/4) from `.github/project/board-sync.json`
