# AUTO-008: Exception queue for leadership
...
```
You are implementing LanceFlow story AUTO-008: Exception queue for leadership.
...
- This story touches: packages/modules/automation, apps/web
