# KPI-003: Control Center summary API
...
| **Depends on** | KPI-002,AUTO-008 |
| **Branch** | `feature/KPI-003-cc-api` |
| **Status** | In Progress |
...
```
You are implementing LanceFlow story KPI-003: Control Center summary API.
