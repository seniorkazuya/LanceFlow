# HIRE-005: Hiring pipeline dashboard
...
```
You are implementing LanceFlow story HIRE-005: Hiring pipeline dashboard.
...
- This story touches: apps/web, packages/modules/hiring
