# DEV-004: Staging deployment pipeline
...
| **Priority** | P0 |
| **Estimate** | 2d |
| **Modules** | `.github/workflows, apps/web` |
| **Depends on** | DEV-003 |
| **Branch** | `feature/DEV-004-deploy-staging` |
| **Status** | Done |
...
- [x] deploy-staging.yml on merge to staging
- [x] Neon staging DB + migrations step
- [x] Health check /api/health post-deploy
- [x] URL documented in PROJECT_STATUS.md — https://lance-flow-web.vercel.app
...
```
You are implementing LanceFlow story DEV-004: Staging deployment pipeline.
...
- This story touches: .github/workflows, apps/web
