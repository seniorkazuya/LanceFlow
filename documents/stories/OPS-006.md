...
| **Depends on** | OPS-003 |
| **Branch** | `feature/OPS-006-daily-reports` |
| **Status** | QA / Staging |
...
- [x] Form: hours, progressPct, issues
- [x] Missing report query for Ops
...
```
You are implementing LanceFlow story OPS-006: Daily self-reporting.
