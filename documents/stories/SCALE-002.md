# SCALE-002: Internal audit role workspace
...
| **Modules** | `apps/web` |
| **Depends on** | CORE-003 |
| **Branch** | `feature/SCALE-002-audit-role` |
| **Status** | Backlog |
...
```
You are implementing LanceFlow story SCALE-002: Internal audit role workspace.
