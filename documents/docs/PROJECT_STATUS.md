...
| | |
|--|--|
| **Active story** | **HIRE-003** — Technical assessment hook (in progress) |
| **Just completed** | **HIRE-002** — Resume parser |
...
| HIRE-003 | (pending) | Technical score 0–100 + assessment webhook |
