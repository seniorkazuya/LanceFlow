...
| | |
|--|--|
| **Active story** | **HIRE-004** — THS/RS calculators (in progress) |
| **Just completed** | **HIRE-003** — Technical assessment hook |
...
| HIRE-004 | (pending) | THS/RS scoring + auto-reject RS > 70 |
